...
- RGI v 5.1.1 tested (instructions for download [here](https://github.com/arpcard/rgi))
- CARD database downloaded and loaded into RGI. 
-   Tested using CARD v 3.1.0 https://card.mcmaster.ca/download/0/broadstreet-v3.1.0.tar.bz2 and the prevalence/variants database 3.0.8 https://card.mcmaster.ca/download/6/prevalence-v3.0.8.tar.bz2
...
- This pipeline uses RGI bwt or the Metagenomic feature of RGI. More information on it can be found [here](https://github.com/arpcard/rgi#id51).
